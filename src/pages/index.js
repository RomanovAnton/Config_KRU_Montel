...
import { buttonAddOL } from "../utils/constant.js";
  ...
  function selectChoose(evt) {
    ...
    switch (currentText.innerText) {
      case "0,5s / 0,5 / 10p":
        addElement(
          column,
          loadElementImage("./images/ТТ_3_3.png", "schema__ТТ-image")
        );
      ...
      case "0,5s / 10p":
        addElement(
          column,
          loadElementImage("./images/ТТ_3_2.png", "schema__ТТ-image")
        );
    ...
    switch (countTT.innerText) {
      case "2":
        addElement(
          column,
          loadElementImage("./images/ТТ_0_0.png", "schema_TT_00")
        );
        break;
      case "3":
